...
module.exports = async (client) => {
    ...
    client.on("guildMemberAdd", async (member) => {
        ...
        try {
            ...
            var backgroundArray = [
              `https://cdn.discordapp.com/attachments/1151952731037245461/1151953139520520292/960x0.png`,
              `https://cdn.discordapp.com/attachments/1151952731037245461/1151953139520520292/960x0.png`,
              `https://cdn.discordapp.com/attachments/1151952731037245461/1151953139520520292/960x0.png`,
              `https://cdn.discordapp.com/attachments/1151952731037245461/1151953139520520292/960x0.png`,
              `https://cdn.discordapp.com/attachments/1151952731037245461/1151953139520520292/960x0.png`,
    ...
    client.on("guildMemberRemove", async (member) => {
      ...
      try {
        ...
        Schema2.findOne({
          ...
          await channel.send({ content: `Look like **${member.user.tag}** just left the server`, files: [attachment] }).catch(err => console.log('I was unable to send goodbye image.'));
